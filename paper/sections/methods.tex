...
\begin{itemize}
  ...
  \item \textbf{Matched seeds:} five independent seeds
        ...
        Dry Bean and high-dimensional parity were subsequently extended to ten
        seeds (adding $\{100, 200, 300, 400, 500\}$) after initial results
        showed large effect sizes that fell short of $\alpha=0.05$ under the
        five-seed design.
\end{itemize}
...
signed-rank test over all available seeds, with effect size reported as Cohen's $d$.
